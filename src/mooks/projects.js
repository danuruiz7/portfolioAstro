const proyectos = [
  //TattoCrm
  {
    title: 'TattoCrm',
    description:
      'App para gestion y registro de trabajos(tatuajes) que se hayan realizado los cliente y generacion automatica de pdf de consentimiento',
    techs: 'Next TS, Tailwind CSS, Prisma ,PostgreSQL',
    image:
      '/tattocrm.png',
    code: 'https://github.com/danuruiz7/TattooCrm',
    preview: 'https://tattocrm.druiz.dev/',
  },
  //Quiz App
  {
    title: 'Quiz App',
    description:
      'App de trivias con distintas categorias para seleccionar ven a probarlas todas...!!!',
    techs: 'React JS, React Router 6, Css',
    image:
      'https://github.com/danuruiz7/quizapp/blob/main/public/preview.png?raw=true',
    code: 'https://github.com/danuruiz7/quizapp',
    preview: 'https://quizapp-dr.vercel.app/',
  },
  //Pagina Web
  {
    title: 'DC Pastel',
    description:
      'Pagina web para una tienda de tartas',
    techs: 'Astro, Tailwind CSS',
    image:
      '/dcpastel.png',
    code: 'https://github.com/danuruiz7/quizapp',
    preview: 'https://dcpastel.druiz.dev/',
  },
  // //TaskAPP
  // {
  //   title: 'TasksApp',
